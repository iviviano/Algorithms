...
- Your `env-lookup` function is missing arguments in the recursive call. Unfortunately, this means that it fails whenever it should recurse. You lost 7 points for each of the four cases that would

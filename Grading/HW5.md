...
- Your `env-lookup` function is missing arguments in the recursive call. Unfortunately, this means that it fails whenever it should recurse. You lost 7 points for each of the four cases that would require recursion. (**-28 points**)
...
- Also, remember that the `struct` construction defines all of the appropriate constructors, recognizers, and accessors for you.

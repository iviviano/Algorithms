...
- You have the right idea for `size-of`, you just didn't do things in the right order. You should find the sum of the recursively determined sizes of the children subtrees. This can be done by `(apply + 1 (map size-of (tree-children t))`

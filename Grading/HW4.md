...
Nice job! It seems like you have a good handle on folds and higher-order functions. Since you struggled a little with recursion on trees, you might want to talk to @

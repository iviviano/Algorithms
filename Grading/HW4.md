...
- You should test every tree procedure on the `empty-tree`. There are lots of tests, but your test suites don't demonstrate the accuracy of the implementations if you 

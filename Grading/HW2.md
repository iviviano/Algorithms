...
Nice job on your implementations! When writing a test suite, it is important to consider possible edge cases. For most functions on lists, this includes the empty input. 

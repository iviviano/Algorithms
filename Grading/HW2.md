...
Problem  4:         9/10 This strategy overcomplicated the delete-sublist? function. It failed on the (delete-sublist '(x y z) '(a b x y z c)). Your function returned '((a b) c) instead of '(a b c).
Problem  5:         8/10 Your base case is wrong for nest. 
Problem  6:         /10
Problem  7:         -1/10
Problem  8:         -1/10
TOTAL:              /100
